...
def roundtrip_1(data, block_size, block_mode,
...
def roundtrip_2(data, block_size, block_mode,
                content_checksum, compression_level,
...
def roundtrip_chunked(data, block_size, block_mode,
                      content_checksum, compression_level,
                      auto_flush, store_size):
...
def get_frame_info_1(data, block_size, block_mode,
                     content_checksum, compression_level,
                     store_size):
    compressed = lz4frame.compress(
        data,
